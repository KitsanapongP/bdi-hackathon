...
(1002, 1, 0, 1, 0, 1, '2026-02-20 17:50:25'),
...
(1002, 'neo', 'neo@gmail.com', '0811111111', 'มหาวิทยาลัยขอนแก่น', 'Khon Kaen University', 'นีโอ', 'เอ', 'Neo', 'A', 1, '2026-02-20 17:50:25', '2026-02-20 17:50:25', NULL),
...
--
ALTER TABLE `team_members`
  MODIFY `team_member_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key of team member record', AUTO_INCREMENT=80010;

--
-- AUTO_INCREMENT for table `team_teams`
--
ALTER TABLE `team_teams`
  MODIFY `team_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key of team', AUTO_INCREMENT=2004;
...
--
ALTER TABLE `user_credentials_local`
  MODIFY `cred_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key of local credentials record', AUTO_INCREMENT=40011;

--
-- AUTO_INCREMENT for table `user_identities`
--
ALTER TABLE `user_identities`
  MODIFY `identity_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key of identity record', AUTO_INCREMENT=50011;
...
--
ALTER TABLE `user_users`
  MODIFY `user_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary key of user', AUTO_INCREMENT=1013;
