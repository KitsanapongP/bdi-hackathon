...
export const SYSTEM_WINDOW_CONFIG_KEYS = {
    ...
    TEAM_SELECTION_SUBMISSION_OPEN_AT: 'TEAM_SELECTION_SUBMISSION_OPEN_AT',
    TEAM_SELECTION_SUBMISSION_CLOSE_AT: 'TEAM_SELECTION_SUBMISSION_CLOSE_AT',
    GLOBAL_SELECTION_CONFIRM_OPEN_AT: 'GLOBAL_SELECTION_CONFIRM_OPEN_AT',
    GLOBAL_SELECTION_CONFIRM_CLOSE_AT: 'GLOBAL_SELECTION_CONFIRM_CLOSE_AT',
};
...
export async function fetchTeamSelectionSubmissionWindowStatus() {
    return fetchWindow(
        SYSTEM_WINDOW_CONFIG_KEYS.TEAM_SELECTION_SUBMISSION_OPEN_AT,
        SYSTEM_WINDOW_CONFIG_KEYS.TEAM_SELECTION_SUBMISSION_CLOSE_AT,
    );
}

export async function fetchGlobalSelectionConfirmWindowStatus() {
    return fetchWindow(
        SYSTEM_WINDOW_CONFIG_KEYS.GLOBAL_SELECTION_CONFIRM_OPEN_AT,
        SYSTEM_WINDOW_CONFIG_KEYS.GLOBAL_SELECTION_CONFIRM_CLOSE_AT,
    );
}
