                    ...
                    <section className="gt-dataset-requirements" aria-label="ข้อกำหนดเกี่ยวกับสิทธิในทรัพย์สินทางปัญญา">
                        ...
                        <div className="gt-dataset-requirement-block">
                            ...
                            <p>
                                ...
                                ตามที่เห็นสมควร โดยจะละเว้นข้อมูลสำคัญที่เป็นความรู้เฉพาะ (Know How) ความลับทางการค้า
                                (Trade Secrets) ข้อมูลที่ยังไม่ได้รับการคุ้มครองด้านทรัพย์สินทางปัญญา
                                หรือข้อมูลที่มีผลกระทบต่อความมั่นคงของประเทศ
                            </p>
                        </div>
                    </section>
                </section>
