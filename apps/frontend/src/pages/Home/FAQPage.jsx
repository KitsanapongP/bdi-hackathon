...
const faqItems = [
    {
        ...
        answer:
            'Concept Deck คือเอกสารสรุปแนวคิดโครงการเบื้องต้น ตาม Topic ที่มีให้ในแบบฟอร์มหรือเทมเพลต ไม่เกิน 1 หน้ากระดาษ โดยส่งได้สูงสุด 2 หัวข้อ (2 Dataset 2 Domain) กรณีที่ส่งมากกว่าหนึ่งโครงร่าง ผู้เข้าร่วมจำเป็นต้องระบุว่าเรื่องใดเป็นเรื่องหลัก และเรื่องใดเป็นเรื่องรอง',
    },
    {
