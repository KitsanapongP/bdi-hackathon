...
const faqItems = [
    ...
    },
    {
        ...
        answer:
            'CV ควรอธิบาย Background ของตนเอง เช่น ประสบการณ์ ความเชี่ยวชาญ หรือรางวัลที่เคยได้รับ ซึ่งมีส่วนสนับสนุนต่อการแข่งขันครั้งนี้ โดยห้ามระบุข้อมูลที่เป็นการเปิดเผยตัวตนของผู้เข้าแข่งขัน เช่น ชื่อบุคคล ชื่อสถาบันที่กำลังศึกษา หรือข้อมูลอื่นใดที่สามารถระบุตัวตนได้ เพื่อรักษาความเป็นธรรมในการประเมินผลงาน',
    },
    {
        question: 'ต้องแนบประกาศนียบัตรหรือหลักฐานความสามารถเพิ่มเติมไหม ?',
        answer:
            'หากมีประกาศนียบัตร หรือหลักฐานอื่นที่แสดงความสามารถของผู้สมัคร ให้รวมไฟล์ส่งพร้อมกับหลักฐานแสดงตัวตน โดยรวมเป็น PDF ไฟล์เดียวก่อนอัปโหลดในหน้าเอกสารยืนยันตัวตนของฉัน',
    },
    {
    ...
    },
    {
        ...
        answer: 'ค่าเดินทางจ่ายตามจริง ทีมละไม่เกิน 5,000 บาท',
    },
    {
